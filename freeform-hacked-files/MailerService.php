...
class MailerService extends Component implements MailHandlerInterface
{
    ...
    ): int
    {
        ...
        $renderEmailEvent = new RenderEmailEvent($form, $notification, $fieldValues, $submission);
        $this->trigger(self::EVENT_BEFORE_RENDER, $renderEmailEvent);
        $fieldValues = $renderEmailEvent->getFieldValues();
